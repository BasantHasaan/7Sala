...
{{ Form::open(array('action' => 'home@doLogin', 'class' => 'form')) }}

<center>
<div class="panel panel-info login_form">
  <div class="panel-heading"><center>
<i class="fa fa-user fa-4x"></i><br><h5>تسجيل الدخول</h5></center>
  </div>
...
<div class="input-group" style="width:80%">
  ...
  <input type="password" class="form-control" name="password" placeholder="كلمه المرور" aria-describedby="basic-addon1" required>
	...
	<div class="row"><br>
	<center>{{ Form::submit('دخول',array('class'=>'btn btn-success btn-expand')) }}</center>
	</div>
</div>
</div>
</center>
